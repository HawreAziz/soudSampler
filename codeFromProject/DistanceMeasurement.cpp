...
void DistanceMeasurement::openCap(){
   cap.open("/home/hawre/Skrivbord/kandidatarbete/sign3.avi"); // change to 0 later
...
void DistanceMeasurement::calculateDis(Point a, Point b, Point c){
   ...
   truckPos.x = WIDTH/2 + 32;   // 32 pixels between the position of the truck and the camera
   truckPos.y = HEIGHT;
